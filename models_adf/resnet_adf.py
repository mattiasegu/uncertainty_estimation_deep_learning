...
def ResNet34ADF(noise_variance=1e-3, min_variance=1e-3):
    return ResNet(BasicBlock, [3,4,6,3], num_classes=10, noise_variance=1e-3, min_variance=1e-3, initialize_msra=False)

def ResNet50ADF(noise_variance=1e-3, min_variance=1e-3):
    return ResNet(Bottleneck, [3,4,6,3], num_classes=10, noise_variance=1e-3, min_variance=1e-3, initialize_msra=False)

def ResNet101ADF(noise_variance=1e-3, min_variance=1e-3):
    return ResNet(Bottleneck, [3,4,23,3], num_classes=10, noise_variance=1e-3, min_variance=1e-3, initialize_msra=False)

def ResNet152ADF(noise_variance=1e-3, min_variance=1e-3):
    return ResNet(Bottleneck, [3,8,36,3], num_classes=10, noise_variance=1e-3, min_variance=1e-3, initialize_msra=False)
